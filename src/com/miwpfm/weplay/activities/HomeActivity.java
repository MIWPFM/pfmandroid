...
public class HomeActivity extends Activity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.find_game) {
        	Toast.makeText(getApplicationContext(), "Buscar partido", Toast.LENGTH_SHORT).show();
            return true;
        } else if (id == R.id.config_notif) {
        	Toast.makeText(getApplicationContext(), "Config. Notificaciones", Toast.LENGTH_SHORT).show();
            return true;
        } else if (id == R.id.share_app) {
        	Toast.makeText(getApplicationContext(), "Compartir app", Toast.LENGTH_SHORT).show();
            return true;
